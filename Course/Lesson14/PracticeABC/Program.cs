...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Cat resp1 = JsonSerializer.Deserialize<Cat>(JsonCat);
        Console.WriteLine(resp1.Fact);

        string Jsonrand = GetRequest("https://official-joke-api.appspot.com/random_joke");
        Joke resp2 = JsonSerializer.Deserialize<Joke>(Jsonrand);
        ...
        List<Univer> resp3 = JsonSerializer.Deserialize<List<Univer>>(JsonUni);
