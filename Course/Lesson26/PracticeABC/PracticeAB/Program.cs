...
public class Program
{
    static void Main()
    {
        ...
        notificationSystem.NewMessage("Получено новое сообщение.");
        notificationSystem.NewOrder("Получен новый заказ.");
        notificationSystem.OrderDelivered("Стальная катана Вергилия 'Yamato'", DateTime.Now.ToString()); //Этот заказ пропитан POWER и MOTIVATION  (перейди по этой ссылке ==> clck.ru/39D7ye)
