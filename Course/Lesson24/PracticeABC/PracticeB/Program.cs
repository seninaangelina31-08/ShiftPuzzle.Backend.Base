...
class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        string url = "https://mykaleidoscope.ru/uploads/posts/2023-05/1685063831_mykaleidoscope-ru-p-kapibara-s-manikyurom-krasivo-32.jpg";
        string localFilePath = "capy.jpg";
        await DownloadFileAsync(url, localFilePath);  

        // Задача 2: Асинхронное чтение и запись файлов
        string filePath = "text.txt";
        await WriteToFileAsync(filePath, "Aaa");
