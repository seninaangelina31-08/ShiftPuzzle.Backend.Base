...
namespace PracticeABC
{
    ...
    public class EFCoreProductRepository : IProductRepository
    {
        ...
        private event Action <string> OnProductDeleted;
        ...
        {
           Console.WriteLine("Отправляю отчет в отдел статистики...");
           Console.WriteLine($"Обновлен продукт: {product.Name}. Новая цена: {product.Price}");    
        }

        private void SendNotificationToStatDepartmentDelete(string name)
        {
           Console.WriteLine("Отправляю отчет в отдел статистики...");
           Console.WriteLine($"Удален продукт: {name}");    
        }
